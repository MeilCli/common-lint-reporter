...
function getInput(key) {
    return _actions_core__WEBPACK_IMPORTED_MODULE_0__/* .getInput */ .V4(key, { required: true });
}
async function run() {
    try {
        const inputPath = getInput("input_path");
        const context = JSON.parse(fs__WEBPACK_IMPORTED_MODULE_1__.readFileSync(inputPath, "utf-8"));
        _actions_core__WEBPACK_IMPORTED_MODULE_0__/* .setOutput */ .uH("pull_request", context.pullRequest ?? "null");
    }
    catch (error) {
...
var y = (x) => (() => (x))
module.exports = x({ ["randomUUID"]: () => (__WEBPACK_EXTERNAL_MODULE_crypto__.randomUUID) });
...
var y = (x) => (() => (x))
module.exports = x({ ["appendFileSync"]: () => (__WEBPACK_EXTERNAL_MODULE_fs__.appendFileSync), ["constants"]: () => (__WEBPACK_EXTERNAL_MODULE_fs__.constants), ["existsSync"]: () => (__WEBPACK_EXTERNAL_MODULE_fs__.existsSync), ["promises"]: () => (__WEBPACK_EXTERNAL_MODULE_fs__.promises), ["readFileSync"]: () => (__WEBPACK_EXTERNAL_MODULE_fs__.readFileSync) });
...
/******/ var __webpack_exports__ = __webpack_require__.O(undefined, [121], () => (__webpack_require__(19322)))
