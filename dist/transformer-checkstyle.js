...
__webpack_require__.d(__webpack_exports__, {
  H: () => (/* binding */ CheckstyleTransformer)
});
...
// EXTERNAL MODULE: ./node_modules/.pnpm/fast-xml-parser@5.10.1/node_modules/fast-xml-parser/src/xmlparser/XMLParser.js
var XMLParser = __webpack_require__(2467);
...
;// ./src/transformer/checkstyle.ts





class CheckstyleTransformer extends Transformer {
    parse(body) {
        const lintResults = [];
        const checkstyles = new XMLParser/* default */.A({
        ...
        for (const checkstyle of checkstyles.checkstyle) {
            for (const checkstyleFile of checkstyle.file ?? []) {
                for (const error of checkstyleFile.error) {
                    const level = error.severity == "warning" ? "warning" : error.severity == "error" ? "failure" : "notice";
                    lintResults.push({
...
/******/ let __webpack_exports__ = __webpack_require__.O(undefined, [121], () => (__webpack_require__(69023)))
