...
var MapOperator = /** @class */ (function (_super) {
    ...
    MapOperator.prototype.createScript = function (method) {
        return "for(const lintResult of source){ const mapped = (".concat(method, ")(Object.assign({}, lintResult)); result.push(mapped); }");
    };
    return MapOperator;
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [736,265,208], () => (__webpack_require__(7965)))
