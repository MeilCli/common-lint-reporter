...
/* harmony import */ var _actions_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(22989);
...
function writeFile(path, lintResults) {
    fs__WEBPACK_IMPORTED_MODULE_0__.writeFileSync(path, JSON.stringify(lintResults));
}
...
async function run() {
    try {
        ...
        const data = option.dataJson != null ? JSON.parse(option.dataJson) : createDefaultData();
...
var y = (x) => (() => (x))
module.exports = x({ ["constants"]: () => (__WEBPACK_EXTERNAL_MODULE_fs__.constants), ["promises"]: () => (__WEBPACK_EXTERNAL_MODULE_fs__.promises), ["writeFileSync"]: () => (__WEBPACK_EXTERNAL_MODULE_fs__.writeFileSync) });
...
/******/ var __webpack_exports__ = __webpack_require__.O(undefined, [121], () => (__webpack_require__(85642)))
