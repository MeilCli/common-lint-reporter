...
var AndroidLintTransformer = /** @class */ (function (_super) {
    __extends(AndroidLintTransformer, _super);
    function AndroidLintTransformer() {
    ...
    return AndroidLintTransformer;
}(transformer_1.Transformer));
exports.AndroidLintTransformer = AndroidLintTransformer;
function run() {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    transformer = new AndroidLintTransformer();
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [736], () => (__webpack_require__(743)))
