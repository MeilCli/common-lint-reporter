    ...
    parse(body) {
        ...
        for (const rubocopFile of rubocopReport.files) {
            for (const message of rubocopFile.offenses) {
                ...
                const startColumn = location.start_line == location.last_line && location.last_column < location.start_column
                    ? location.last_column
                    : location.start_column;
                const endColumn = location.start_line == location.last_line && location.last_column < location.start_column
                    ? location.start_column
                    : location.last_column;
                lintResults.push({
...
/******/ let __webpack_exports__ = __webpack_require__.O(undefined, [121], () => (__webpack_require__(85693)))
/******/ __webpack_exports__ = __webpack_require__.O(__webpack_exports__);
/******/ const __webpack_exports__RubocopTransformer = __webpack_exports__.e;
/******/ export { __webpack_exports__RubocopTransformer as RubocopTransformer };
/******/ 
