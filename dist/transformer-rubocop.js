...
var RubocopTransformer = /** @class */ (function (_super) {
    __extends(RubocopTransformer, _super);
    function RubocopTransformer() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    RubocopTransformer.prototype.parse = function (body) {
        var lintResults = [];
        var rubocopReport = JSON.parse(body);
        for (var _i = 0, _a = rubocopReport.files; _i < _a.length; _i++) {
            var rubocopFile = _a[_i];
            for (var _b = 0, _c = rubocopFile.offenses; _b < _c.length; _b++) {
                var message = _c[_b];
                var level = "notice";
                ...
                var searchTarget = "".concat(message.cop_name, ": ");
                var ruleIndex = message.message.indexOf(searchTarget);
                if (ruleIndex < 0) {
                    continue;
                }
                var escapedMessage = message.message.slice(ruleIndex + searchTarget.length);
                var location_1 = message.location;
                var startColumn = location_1.start_line == location_1.last_line && location_1.last_column < location_1.start_column
                    ? location_1.last_column
                    : location_1.start_column;
                var endColumn = location_1.start_line == location_1.last_line && location_1.last_column < location_1.start_column
                    ? location_1.start_column
                    : location_1.last_column;
                lintResults.push({
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    transformer = new RubocopTransformer();
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [736], () => (__webpack_require__(9686)))
