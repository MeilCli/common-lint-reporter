...
exports.GetCheckRunAnnotations = graphql_tag_1.default(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n    query GetCheckRunAnnotations($checkRunId: ID!, $after: String) {\n  node(id: $checkRunId) {\n    __typename\n    ... on CheckRun {\n      id\n      annotations(first: 100, after: $after) {\n        pageInfo {\n          hasNextPage\n          endCursor\n        }\n        nodes {\n          path\n          message\n          title\n          annotationLevel\n          location {\n            start {\n              line\n              column\n            }\n            end {\n              line\n              column\n            }\n          }\n        }\n      }\n    }\n  }\n}\n    "], ["\n    query GetCheckRunAnnotations($checkRunId: ID!, $after: String) {\n  node(id: $checkRunId) {\n    __typename\n    ... on CheckRun {\n      id\n      annotations(first: 100, after: $after) {\n        pageInfo {\n          hasNextPage\n          endCursor\n        }\n        nodes {\n          path\n          message\n          title\n          annotationLevel\n          location {\n            start {\n              line\n              column\n            }\n            end {\n              line\n              column\n            }\n          }\n        }\n      }\n    }\n  }\n}\n    "])));
exports.GetCommitStatusAndCheckRun = graphql_tag_1.default(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n    query GetCommitStatusAndCheckRun($owner: String!, $name: String!, $commitSha: GitObjectID!, $after: String) {\n  repository(owner: $owner, name: $name) {\n    object(oid: $commitSha) {\n      ... on Commit {\n        statusCheckRollup {\n          contexts(first: 100, after: $after) {\n            pageInfo {\n              hasNextPage\n              endCursor\n            }\n            nodes {\n              __typename\n              ... on StatusContext {\n                id\n                state\n                context\n              }\n              ... on CheckRun {\n                id\n                name\n                status\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n}\n    "], ["\n    query GetCommitStatusAndCheckRun($owner: String!, $name: String!, $commitSha: GitObjectID!, $after: String) {\n  repository(owner: $owner, name: $name) {\n    object(oid: $commitSha) {\n      ... on Commit {\n        statusCheckRollup {\n          contexts(first: 100, after: $after) {\n            pageInfo {\n              hasNextPage\n              endCursor\n            }\n            nodes {\n              __typename\n              ... on StatusContext {\n                id\n                state\n                context\n              }\n              ... on CheckRun {\n                id\n                name\n                status\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n}\n    "])));
exports.GetLoginUser = graphql_tag_1.default(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n    query GetLoginUser {\n  viewer {\n    login\n  }\n}\n    "], ["\n    query GetLoginUser {\n  viewer {\n    login\n  }\n}\n    "])));
exports.GetPullRequestChangedFile = graphql_tag_1.default(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n    query GetPullRequestChangedFile($owner: String!, $name: String!, $pull_request: Int!, $after: String) {\n  repository(owner: $owner, name: $name) {\n    pullRequest(number: $pull_request) {\n      files(first: 100, after: $after) {\n        pageInfo {\n          hasNextPage\n          endCursor\n        }\n        nodes {\n          path\n        }\n      }\n    }\n  }\n}\n    "], ["\n    query GetPullRequestChangedFile($owner: String!, $name: String!, $pull_request: Int!, $after: String) {\n  repository(owner: $owner, name: $name) {\n    pullRequest(number: $pull_request) {\n      files(first: 100, after: $after) {\n        pageInfo {\n          hasNextPage\n          endCursor\n        }\n        nodes {\n          path\n        }\n      }\n    }\n  }\n}\n    "])));
exports.GetPullRequestComment = graphql_tag_1.default(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n    query GetPullRequestComment($owner: String!, $name: String!, $pull_request: Int!, $after: String) {\n  repository(owner: $owner, name: $name) {\n    pullRequest(number: $pull_request) {\n      id\n      comments(first: 100, after: $after) {\n        pageInfo {\n          hasNextPage\n          endCursor\n        }\n        nodes {\n          author {\n            login\n          }\n          id\n          body\n        }\n      }\n    }\n  }\n}\n    "], ["\n    query GetPullRequestComment($owner: String!, $name: String!, $pull_request: Int!, $after: String) {\n  repository(owner: $owner, name: $name) {\n    pullRequest(number: $pull_request) {\n      id\n      comments(first: 100, after: $after) {\n        pageInfo {\n          hasNextPage\n          endCursor\n        }\n        nodes {\n          author {\n            login\n          }\n          id\n          body\n        }\n      }\n    }\n  }\n}\n    "])));
exports.GetPullRequestReviewThreads = graphql_tag_1.default(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n    query GetPullRequestReviewThreads($owner: String!, $name: String!, $number: Int!, $after: String) {\n  repository(owner: $owner, name: $name) {\n    pullRequest(number: $number) {\n      reviewThreads(first: 100, after: $after) {\n        pageInfo {\n          hasNextPage\n          endCursor\n        }\n        nodes {\n          id\n          path\n          line\n          startLine\n          isOutdated\n          isResolved\n          comments(first: 1) {\n            pageInfo {\n              hasNextPage\n            }\n            nodes {\n              id\n              body\n              author {\n                login\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n}\n    "], ["\n    query GetPullRequestReviewThreads($owner: String!, $name: String!, $number: Int!, $after: String) {\n  repository(owner: $owner, name: $name) {\n    pullRequest(number: $number) {\n      reviewThreads(first: 100, after: $after) {\n        pageInfo {\n          hasNextPage\n          endCursor\n        }\n        nodes {\n          id\n          path\n          line\n          startLine\n          isOutdated\n          isResolved\n          comments(first: 1) {\n            pageInfo {\n              hasNextPage\n            }\n            nodes {\n              id\n              body\n              author {\n                login\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n}\n    "])));
exports.GetPullRequest = graphql_tag_1.default(templateObject_13 || (templateObject_13 = __makeTemplateObject(["\n    query GetPullRequest($owner: String!, $name: String!, $number: Int!) {\n  repository(owner: $owner, name: $name) {\n    pullRequest(number: $number) {\n      id\n    }\n  }\n}\n    "], ["\n    query GetPullRequest($owner: String!, $name: String!, $number: Int!) {\n  repository(owner: $owner, name: $name) {\n    pullRequest(number: $number) {\n      id\n    }\n  }\n}\n    "])));
exports.GetRepositoryId = graphql_tag_1.default(templateObject_14 || (templateObject_14 = __makeTemplateObject(["\n    query GetRepositoryId($owner: String!, $name: String!) {\n  repository(owner: $owner, name: $name) {\n    id\n  }\n}\n    "], ["\n    query GetRepositoryId($owner: String!, $name: String!) {\n  repository(owner: $owner, name: $name) {\n    id\n  }\n}\n    "])));
exports.ResolvePullRequestReviewThread = graphql_tag_1.default(templateObject_15 || (templateObject_15 = __makeTemplateObject(["\n    mutation ResolvePullRequestReviewThread($pullRequestThreadId: ID!) {\n  resolveReviewThread(input: {threadId: $pullRequestThreadId}) {\n    clientMutationId\n  }\n}\n    "], ["\n    mutation ResolvePullRequestReviewThread($pullRequestThreadId: ID!) {\n  resolveReviewThread(input: {threadId: $pullRequestThreadId}) {\n    clientMutationId\n  }\n}\n    "])));
exports.UpdateCheckRun = graphql_tag_1.default(templateObject_16 || (templateObject_16 = __makeTemplateObject(["\n    mutation UpdateCheckRun($repositoryId: ID!, $checkRunId: ID!, $completedAt: DateTime, $conclusion: CheckConclusionState, $status: RequestableCheckStatusState, $output: CheckRunOutput) {\n  updateCheckRun(\n    input: {repositoryId: $repositoryId, checkRunId: $checkRunId, completedAt: $completedAt, conclusion: $conclusion, status: $status, output: $output}\n  ) {\n    clientMutationId\n  }\n}\n    "], ["\n    mutation UpdateCheckRun($repositoryId: ID!, $checkRunId: ID!, $completedAt: DateTime, $conclusion: CheckConclusionState, $status: RequestableCheckStatusState, $output: CheckRunOutput) {\n  updateCheckRun(\n    input: {repositoryId: $repositoryId, checkRunId: $checkRunId, completedAt: $completedAt, conclusion: $conclusion, status: $status, output: $output}\n  ) {\n    clientMutationId\n  }\n}\n    "])));
