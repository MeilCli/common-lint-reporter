...
class DotnetFormatTransformer extends transformer_1.Transformer {
    parse(body) {
        const lintResults = [];
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [968], () => (__webpack_require__(7548)))
