...
var DotnetFormatTransformer = /** @class */ (function (_super) {
    __extends(DotnetFormatTransformer, _super);
    function DotnetFormatTransformer() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DotnetFormatTransformer.prototype.parse = function (body) {
        var lintResults = [];
        var dotnetFormatReports = JSON.parse(body);
        for (var _i = 0, dotnetFormatReports_1 = dotnetFormatReports; _i < dotnetFormatReports_1.length; _i++) {
            var dotnetFormatReport = dotnetFormatReports_1[_i];
            for (var _a = 0, _b = dotnetFormatReport.FileChanges; _a < _b.length; _a++) {
                var changes = _b[_a];
                lintResults.push({
    ...
    return DotnetFormatTransformer;
}(transformer_1.Transformer));
exports.DotnetFormatTransformer = DotnetFormatTransformer;
function run() {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    transformer = new DotnetFormatTransformer();
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [736], () => (__webpack_require__(9002)))
