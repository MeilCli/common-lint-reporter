import { Script as __WEBPACK_EXTERNAL_MODULE_vm_Script__ } from "vm";
...
var glob = __webpack_require__(37160);
;// external "vm"
...
// EXTERNAL MODULE: ./node_modules/.pnpm/@apollo+client@4.2.10_graphql-ws@6.2.1_graphql@16.14.2_ws@8.21.0__graphql@16.14.2_react@19.2.8_rxjs@7.8.2/node_modules/@apollo/client/core/ApolloClient.js + 3 modules
var ApolloClient = __webpack_require__(94199);
// EXTERNAL MODULE: ./node_modules/.pnpm/@apollo+client@4.2.10_graphql-ws@6.2.1_graphql@16.14.2_ws@8.21.0__graphql@16.14.2_react@19.2.8_rxjs@7.8.2/node_modules/@apollo/client/link/http/HttpLink.js + 8 modules
var HttpLink = __webpack_require__(78264);
// EXTERNAL MODULE: ./node_modules/.pnpm/@apollo+client@4.2.10_graphql-ws@6.2.1_graphql@16.14.2_ws@8.21.0__graphql@16.14.2_react@19.2.8_rxjs@7.8.2/node_modules/@apollo/client/cache/inmemory/inMemoryCache.js + 7 modules
var inMemoryCache = __webpack_require__(34452);
// EXTERNAL MODULE: ./graphql/graphql.ts + 2 modules
var graphql = __webpack_require__(91399);
...
class FunctionalOperator extends Operator {
    async execute(lintResults, option) {
        ...
        const script = new __WEBPACK_EXTERNAL_MODULE_vm_Script__(this.createScript(option.func));
...
class AddOperator extends FunctionalOperator {
    createScript(method) {
        return `
const add = (x) => {
...
/******/ let __webpack_exports__ = __webpack_require__.O(undefined, [121,630], () => (__webpack_require__(13808)))
/******/ __webpack_exports__ = __webpack_require__.O(__webpack_exports__);
/******/ const __webpack_exports__AddOperator = __webpack_exports__.w;
/******/ export { __webpack_exports__AddOperator as AddOperator };
/******/ 
