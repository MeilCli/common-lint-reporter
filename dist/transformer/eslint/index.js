...
function run() {
    var e_1, _a;
    return __awaiter(this, void 0, void 0, function () {
        var option, globber, _b, _c, path, lintResults, esLintReports, _i, esLintReports_1, esLintReport, _d, _e, message, level, e_1_1, error_1;
                ...
                case 4:
                    ...
                    for (_i = 0, esLintReports_1 = esLintReports; _i < esLintReports_1.length; _i++) {
                        ...
                        for (_d = 0, _e = esLintReport.messages; _d < _e.length; _d++) {
                            message = _e[_d];
                            level = message.severity == 1 ? "warning" : "failure";
                            lintResults.push({
