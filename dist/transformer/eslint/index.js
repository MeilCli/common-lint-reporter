...
var option_1 = __nccwpck_require__(510);
var transformer_1 = __nccwpck_require__(551);
var EslintTransformer = /** @class */ (function (_super) {
    __extends(EslintTransformer, _super);
    function EslintTransformer() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    EslintTransformer.prototype.parse = function (body) {
        var lintResults = [];
        var esLintReports = JSON.parse(body);
        for (var _i = 0, esLintReports_1 = esLintReports; _i < esLintReports_1.length; _i++) {
            var esLintReport = esLintReports_1[_i];
            for (var _a = 0, _b = esLintReport.messages; _a < _b.length; _a++) {
                var message = _b[_a];
                var level = message.severity == 1 ? "warning" : "failure";
                lintResults.push({
    ...
    return EslintTransformer;
}(transformer_1.Transformer));
exports.EslintTransformer = EslintTransformer;
function run() {
    return __awaiter(this, void 0, void 0, function () {
...
var glob = __importStar(__nccwpck_require__(90));
