...
var DistinctOperator = /** @class */ (function (_super) {
    __extends(DistinctOperator, _super);
    function DistinctOperator() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DistinctOperator.prototype.createScript = function (method) {
        return "\nconst keys = [];\nfor(const lintResult of source){\n    const key = (".concat(method, ")(Object.assign({}, lintResult)); \n    if(keys.includes(key))\n        continue;\n    result.push(lintResult); \n    keys.push(key);\n}");
    };
...
var FunctionalOperator = /** @class */ (function (_super) {
    __extends(FunctionalOperator, _super);
    function FunctionalOperator() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
