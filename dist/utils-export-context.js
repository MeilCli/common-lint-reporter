...
async function run() {
    try {
        const context = {
            pullRequest: (0, context_1.githubContext)(null).pullRequest(),
        };
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [736], () => (__webpack_require__(7512)))
