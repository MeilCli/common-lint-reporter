...
class EslintTransformer extends transformer_1.Transformer {
    parse(body) {
        const lintResults = [];
        const esLintReports = JSON.parse(body);
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [121], () => (__webpack_require__(491)))
